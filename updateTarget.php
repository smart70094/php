<?php
	...
	$sql="UPDATE ".$table." SET targetName='$targetName' , targetContent='$targetContent' , targetStartTime='$targetStartTime' , targetEndTime='$targetEndTime' , state='$state' , auth='$auth' WHERE tid='$tid'";
